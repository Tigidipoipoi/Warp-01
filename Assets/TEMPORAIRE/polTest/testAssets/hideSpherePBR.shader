...
Shader "Custom/hideSpherePBR" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float4 _regT_color;
            uniform float4 _glitchT_color;
...
////// Specular:
                ...
                float node_462 = (1.0 - sqrt(sqrt(_HIDE)));
                float3 diffuseColor = ((_regT_var.rgb*_regT_color.rgb)*node_462); // Need this for specular when using metallic
...
////// Emissive:
                ...
                float2 node_3 = (i.uv0+node_7380.g*float2(20,20));
                float4 _glitchT_var = tex2D(_glitchT,TRANSFORM_TEX(node_3, _glitchT));
                float3 emissive = ((_glitchT_var.rgb*_glitchT_color.rgb)*pow(_HIDE,3.0));
/// Final Color:
