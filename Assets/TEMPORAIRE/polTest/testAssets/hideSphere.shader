...
////// Specular:
                ...
                float3 specularColor = float3(_regT_var.r,_regT_var.r,_regT_var.r);
...
/////// Diffuse:
                ...
                float node_462 = (1.0 - sqrt(sqrt(_HIDE)));
                float3 diffuseColor = ((_regT_var.rgb*_regT_color.rgb)*node_462);
                float3 diffuse = (directDiffuse + indirectDiffuse) * diffuseColor;
////// Emissive:
                float4 node_9725 = _Time + _TimeEditor;
                float2 node_3 = (i.uv0+node_9725.g*float2(20,20));
