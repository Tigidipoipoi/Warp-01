    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_6955 = _Time + _TimeEditor;
                float2 node_1383 = mul(_Object2World, v.vertex).rgb.rg;
                float2 node_520 = (node_1383+node_6955.g*float2(0,0.2));
                ...
                float2 node_1025 = (node_1050+node_6955.g*float2(0.1,0.1));
                ...
                float3 node_9106 = (node_3581*mul( _World2Object, float4(normalize((mul(_Object2World, v.vertex).rgb-objPos.rgb)),0) ).xyz.rgb*node_5039);
                v.vertex.xyz += (node_9106*_displace);
...
/////// Diffuse:
                ...
                float3 node_3581 = (_glitched_var.rgb*0.7+0.5);
                float3 diffuseColor = lerp(_regular_var.rgb,lerp(sin(float3((_node_5925.rgb.rg+node_6955.g*float2(-1,-1)),_node_5925.b)),sin(float3((_node_5925.rgb.gb+node_6955.g*float2(1,1)),_node_5925.r)),node_3581),node_5039);
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_1383 = mul(_Object2World, v.vertex).rgb.rg;
                float2 node_520 = (node_1383+node_5599.g*float2(0,0.2));
                float4 _glitched_var = tex2Dlod(_glitched,float4(TRANSFORM_TEX(node_520, _glitched),0.0,0));
                float3 node_3581 = (_glitched_var.rgb*0.7+0.5);
                float4 node_3801 = _Time + _TimeEditor;
                float node_1050_ang = (node_3801.g*_speedMove);
                ...
                float2 node_1050_piv = float2(0.5,0.5);
                float2 node_1050 = (mul(float2((mul(_Object2World, v.vertex).r+mul(_Object2World, v.vertex).g),(mul(_Object2World, v.vertex).g+mul(_Object2World, v.vertex).b))-node_1050_piv,float2x2( node_1050_cos, -node_1050_sin, node_1050_sin, node_1050_cos))+node_1050_piv);
                float2 node_1025 = (node_1050+node_5599.g*float2(0.1,0.1));
                float4 _mask_var = tex2Dlod(_mask,float4(TRANSFORM_TEX(node_1025, _mask),0.0,0));
                float3 node_5039 = saturate((_mask_var.rgb*2.0+0.0));
                float3 node_9106 = (node_3581*mul( _World2Object, float4(normalize((mul(_Object2World, v.vertex).rgb-objPos.rgb)),0) ).xyz.rgb*node_5039);
                v.vertex.xyz += (node_9106*_displace);
...
/////// Diffuse:
                ...
                float4 _glitched_var = tex2D(_glitched,TRANSFORM_TEX(node_520, _glitched));
                float3 node_3581 = (_glitched_var.rgb*0.7+0.5);
                float3 diffuseColor = lerp(_regular_var.rgb,lerp(sin(float3((_node_5925.rgb.rg+node_5599.g*float2(-1,-1)),_node_5925.b)),sin(float3((_node_5925.rgb.gb+node_5599.g*float2(1,1)),_node_5925.r)),node_3581),node_5039);
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                VertexOutput o = (VertexOutput)0;
                float4 objPos = mul ( _Object2World, float4(0,0,0,1) );
                float4 node_765 = _Time + _TimeEditor;
                float2 node_1383 = mul(_Object2World, v.vertex).rgb.rg;
                float2 node_520 = (node_1383+node_765.g*float2(0,0.2));
                float4 _glitched_var = tex2Dlod(_glitched,float4(TRANSFORM_TEX(node_520, _glitched),0.0,0));
                float3 node_3581 = (_glitched_var.rgb*0.7+0.5);
                float4 node_3801 = _Time + _TimeEditor;
                float node_1050_ang = (node_3801.g*_speedMove);
                ...
                float2 node_1050_piv = float2(0.5,0.5);
                float2 node_1050 = (mul(float2((mul(_Object2World, v.vertex).r+mul(_Object2World, v.vertex).g),(mul(_Object2World, v.vertex).g+mul(_Object2World, v.vertex).b))-node_1050_piv,float2x2( node_1050_cos, -node_1050_sin, node_1050_sin, node_1050_cos))+node_1050_piv);
                float2 node_1025 = (node_1050+node_765.g*float2(0.1,0.1));
                float4 _mask_var = tex2Dlod(_mask,float4(TRANSFORM_TEX(node_1025, _mask),0.0,0));
                float3 node_5039 = saturate((_mask_var.rgb*2.0+0.0));
                float3 node_9106 = (node_3581*mul( _World2Object, float4(normalize((mul(_Object2World, v.vertex).rgb-objPos.rgb)),0) ).xyz.rgb*node_5039);
                v.vertex.xyz += (node_9106*_displace);
